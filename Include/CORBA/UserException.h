...
return (ep && ::CORBA::Internal::RepId::compatible (ep->_rep_id (), ::CORBA::Internal::RepIdOf <Parent E>::id_))\
? &static_cast <const Parent E&> (*ep) : nullptr; }\
const char* Parent E::_rep_id () const NIRVANA_NOEXCEPT { return ::CORBA::Internal::RepIdOf <Parent E>::id_; }\
