...
void set_exception (Interface_ptr environment, Exception::Code code, const Char* rep_id, const void* param) NIRVANA_NOEXCEPT
{
...
void set_exception (Interface_ptr environment, const Exception& e) NIRVANA_NOEXCEPT
{
	set_exception (environment, e.__code (), e._rep_id (), e.__data ());
}

void set_unknown_exception (Interface_ptr environment) NIRVANA_NOEXCEPT
{
